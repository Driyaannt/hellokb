    ...
    function toggleSelect(card, cardName) {
      ...
      if (card.classList.contains('selected')) {
        if (selectedCards.length >= 2) {
            // Tampilkan SweetAlert jika lebih dari dua pilihan
            Swal.fire({
                icon: 'warning',
                title: 'Batas Maksimal Pilihan',
                text: 'Anda hanya dapat memilih dua opsi saja. untuk lebih lannjut dapat bertanhya kepada bidan anda',
            });
            // Batalkan penambahan kelas 'selected'
